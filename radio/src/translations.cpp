...
const char STR_MAVLINK[] = TR_MAVLINK;
const char STR_MAVLINK_RSSI[] = TR_MAVLINK_RSSI;
const char STR_MAVLINK_RSSI_SCALE[] = TR_MAVLINK_RSSI_SCALE;
const char STR_MAVLINK_SENSOR_MIMICRY[] = TR_MAVLINK_SENSOR_MIMICRY;
const char STR_MAVLINK_RC_OVERRIDE[] = TR_MAVLINK_RC_OVERRIDE;
ISTR(MAVLINK_AUX_SERIAL_MODES);
ISTR(MAVLINK_AUX_BAUDRATES);
const char STR_MAVLINK_EXTERNAL[] = TR_MAVLINK_EXTERNAL;
const char STR_USB_MAVLINK[] = TR_USB_MAVLINK;
#endif
